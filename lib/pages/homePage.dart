              ...
              builder: (BuildContext context,
                ...
                final List<Project> projects =
                  ...
                  return Project(
                    ...
                    // projectImage: ' ',
                    projectDescription: document['desc'],
                    projectImage: document['imageURL'],
                    projectClient: document['client'],
                    projectComments: document['comments'],
                  );
                }).toList();
                final List<Project> pinnedProjects = projects.take(4).toList();
                  ...
                  body: Column(
                    children: [
                      Padding(
                          ...
                          child: Text("Quick Actions", style: TextStyle(fontSize: 30,), textAlign: TextAlign.center,),
                      ),
                      SizedBox(
                                    ...
                                    return Expanded(
                                      child: GestureDetector(
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => ClientsProfile(
                                              client: pinnedClients[index],
                                            )),
                                          );
                                        },
                                        child: Container(
